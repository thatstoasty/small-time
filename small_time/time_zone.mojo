...
struct TimeZone(Copyable, ExplicitlyCopyable, Movable):
    ...
    var offset: Int
    """Offset in seconds."""
    alias ASIA_JAKARTA = Self(name="Asia/Jakarta", offset=25200)
    alias LIBYA = Self(name="Libya", offset=7200)
    alias AMERICA_IQALUIT = Self(name="America/Iqaluit", offset=-18000)
    alias AMERICA_INDIANA_VEVAY = Self(name="America/Indiana/Vevay", offset=-18000)
    alias ATLANTIC_SOUTH_GEORGIA = Self(name="Atlantic/South_Georgia", offset=-7200)
    alias AMERICA_CUIABA = Self(name="America/Cuiaba", offset=-14400)
    alias EUROPE_TALLINN = Self(name="Europe/Tallinn", offset=7200)
    alias AMERICA_ENSENADA = Self(name="America/Ensenada", offset=-28800)
    alias AFRICA_ABIDJAN = Self(name="Africa/Abidjan", offset=0)
    alias PACIFIC_SAIPAN = Self(name="Pacific/Saipan", offset=36000)
    alias MEXICO_GENERAL = Self(name="Mexico/General", offset=-21600)
    alias EUROPE_ROME = Self(name="Europe/Rome", offset=3600)
    alias ASIA_SEOUL = Self(name="Asia/Seoul", offset=32400)
    alias US_MICHIGAN = Self(name="US/Michigan", offset=-18000)
    alias AMERICA_NEW_YORK = Self(name="America/New_York", offset=-18000)
    alias EUROPE_ATHENS = Self(name="Europe/Athens", offset=7200)
    alias EUROPE_LISBON = Self(name="Europe/Lisbon", offset=0)
    alias AMERICA_ST_THOMAS = Self(name="America/St_Thomas", offset=-14400)
    alias EUROPE_MOSCOW = Self(name="Europe/Moscow", offset=10800)
    alias PACIFIC_EASTER = Self(name="Pacific/Easter", offset=-21600)
    alias AMERICA_PORTO_ACRE = Self(name="America/Porto_Acre", offset=-18000)
    alias AMERICA_CRESTON = Self(name="America/Creston", offset=-25200)
    alias PACIFIC_NORFOLK = Self(name="Pacific/Norfolk", offset=43200)
    alias AMERICA_ARGENTINA_CORDOBA = Self(name="America/Argentina/Cordoba", offset=-10800)
    alias AMERICA_ATKA = Self(name="America/Atka", offset=-36000)
    alias PACIFIC_NIUE = Self(name="Pacific/Niue", offset=-39600)
    alias ASIA_ULAN_BATOR = Self(name="Asia/Ulan_Bator", offset=28800)
    alias EUROPE_SIMFEROPOL = Self(name="Europe/Simferopol", offset=10800)
    alias ASIA_DILI = Self(name="Asia/Dili", offset=32400)
    alias EUROPE_ZAGREB = Self(name="Europe/Zagreb", offset=3600)
    alias ANTARCTICA_PALMER = Self(name="Antarctica/Palmer", offset=-10800)
    alias AMERICA_CAYENNE = Self(name="America/Cayenne", offset=-10800)
    alias ASIA_TEL_AVIV = Self(name="Asia/Tel_Aviv", offset=7200)
    alias ASIA_URUMQI = Self(name="Asia/Urumqi", offset=21600)
    alias ASIA_BEIRUT = Self(name="Asia/Beirut", offset=7200)
    alias ASIA_KUALA_LUMPUR = Self(name="Asia/Kuala_Lumpur", offset=28800)
    alias AMERICA_BELEM = Self(name="America/Belem", offset=-10800)
    alias PACIFIC_HONOLULU = Self(name="Pacific/Honolulu", offset=-36000)
    alias AMERICA_SANTA_ISABEL = Self(name="America/Santa_Isabel", offset=-28800)
    alias PACIFIC_KWAJALEIN = Self(name="Pacific/Kwajalein", offset=43200)
    alias AFRICA_LUANDA = Self(name="Africa/Luanda", offset=3600)
    alias AMERICA_CHICAGO = Self(name="America/Chicago", offset=-21600)
    alias ASIA_HARBIN = Self(name="Asia/Harbin", offset=28800)
    alias EUROPE_PARIS = Self(name="Europe/Paris", offset=3600)
    alias PACIFIC_WALLIS = Self(name="Pacific/Wallis", offset=43200)
    alias AMERICA_ARGENTINA_USHUAIA = Self(name="America/Argentina/Ushuaia", offset=-10800)
    alias AUSTRALIA_ADelaide = Self(name="Australia/Adelaide", offset=37800)
    alias ASIA_SINGAPORE = Self(name="Asia/Singapore", offset=28800)
    alias AMERICA_KRALENDIJK = Self(name="America/Kralendijk", offset=-14400)
    alias AMERICA_MONCTON = Self(name="America/Moncton", offset=-14400)
    alias AMERICA_ARUBA = Self(name="America/Aruba", offset=-14400)
    alias AMERICA_NORONHA = Self(name="America/Noronha", offset=-7200)
    alias ETC_UTC = Self(name="Etc/UTC", offset=0)
    alias AFRICA_LUSAKA = Self(name="Africa/Lusaka", offset=7200)
    alias ASIA_TOMSK = Self(name="Asia/Tomsk", offset=25200)
    alias ASIA_PHNOM_PENH = Self(name="Asia/Phnom_Penh", offset=25200)
    alias ASIA_SAMARKAND = Self(name="Asia/Samarkand", offset=18000)
    alias EUROPE_LUXEMBOURG = Self(name="Europe/Luxembourg", offset=3600)
    alias INDIAN_ANTANANARIVO = Self(name="Indian/Antananarivo", offset=10800)
    alias ETC_GMT_PLUS_1 = Self(name="Etc/GMT+1", offset=-3600)
    alias AMERICA_PORTO_VELHO = Self(name="America/Porto_Velho", offset=-14400)
    alias GB = Self(name="GB", offset=0)
    alias AMERICA_BARbADOS = Self(name="America/Barbados", offset=-14400)
    alias ASIA_CHUNGKING = Self(name="Asia/Chungking", offset=28800)
    alias ASIA_SHANGHAI = Self(name="Asia/Shanghai", offset=28800)
    alias ETC_GMT_13 = Self(name="Etc/GMT-13", offset=46800)
    alias AMERICA_INDIANA_INDIANAPOLIS = Self(name="America/Indiana/Indianapolis", offset=-18000)
    alias AMERICA_INDIANA_VINCENNES = Self(name="America/Indiana/Vincennes", offset=-18000)
    alias AMERICA_INDIANA_TELL_CITY = Self(name="America/Indiana/Tell_City", offset=-21600)
    alias PACIFIC_KANTON = Self(name="Pacific/Kanton", offset=46800)
    alias AMERICA_NASSAU = Self(name="America/Nassau", offset=-18000)
    alias AMERICA_RIO_BRANCO = Self(name="America/Rio_Branco", offset=-18000)
    alias GMT_MINUS_0 = Self(name="GMT-0", offset=0)
    alias AUSTRALIA_TASMANIA = Self(name="Australia/Tasmania", offset=36000)
    alias PACIFIC_KOSRAE = Self(name="Pacific/Kosrae", offset=39600)
    alias US_HAWAII = Self(name="US/Hawaii", offset=-36000)
    alias ASIA_TBILISI = Self(name="Asia/Tbilisi", offset=14400)
    alias PACIFIC_BOUGAINVILLE = Self(name="Pacific/Bougainville", offset=39600)
    alias EUROPE_VADUZ = Self(name="Europe/Vaduz", offset=3600)
    alias ETC_GMT_PLUS_11 = Self(name="Etc/GMT+11", offset=-39600)
    alias AFRICA_WINDHOEK = Self(name="Africa/Windhoek", offset=7200)
    alias ATLANTIC_JAN_MAYEN = Self(name="Atlantic/Jan_Mayen", offset=3600)
    alias AFRICA_NDJAMENA = Self(name="Africa/Ndjamena", offset=3600)
    alias AMERICA_ADAK = Self(name="America/Adak", offset=-36000)
    alias ISRAEL = Self(name="Israel", offset=7200)
    alias US_INDiana_STARKE = Self(name="US/Indiana-Starke", offset=-21600)
    alias AMERICA_NORTH_DAKOTA_NEW_SALEM = Self(name="America/North_Dakota/New_Salem", offset=-21600)
    alias PACIFIC_PALAU = Self(name="Pacific/Palau", offset=32400)
    alias GMT_PLUS_0 = Self(name="GMT+0", offset=0)
    alias AMERICA_RAINY_RIVER = Self(name="America/Rainy_River", offset=-21600)
    alias AMERICA_WINNIPEG = Self(name="America/Winnipeg", offset=-21600)
    alias ETC_GREENWICH = Self(name="Etc/Greenwich", offset=0)
    alias AMERICA_PANGNIRTUNG = Self(name="America/Pangnirtung", offset=-14400)
    alias AFRICA_TRIPOLI = Self(name="Africa/Tripoli", offset=7200)
    alias AMERICA_GUATEMALA = Self(name="America/Guatemala", offset=-21600)
    alias ASIA_NICOSIA = Self(name="Asia/Nicosia", offset=7200)
    alias AMERICA_BELIZE = Self(name="America/Belize", offset=-21600)
    alias AMERICA_RESOLUTE = Self(name="America/Resolute", offset=-21600)
    alias ASIA_HEBRON = Self(name="Asia/Hebron", offset=7200)
    alias AMERICA_CARACAS = Self(name="America/Caracas", offset=-14400)
    alias ASIA_NOVOSIBIRSK = Self(name="Asia/Novosibirsk", offset=25200)
    alias EUROPE_PODGORICA = Self(name="Europe/Podgorica", offset=3600)
    alias PRC = Self(name="PRC", offset=28800)
    alias EUROPE_KALININGRAD = Self(name="Europe/Kaliningrad", offset=7200)
    alias EUROPE_ZURICH = Self(name="Europe/Zurich", offset=3600)
    alias AMERICA_ST_BARTHELEMY = Self(name="America/St_Barthelemy", offset=-14400)
    alias AMERICA_NUUK = Self(name="America/Nuuk", offset=-7200)
    alias ETC_GMT_PLUS_12 = Self(name="Etc/GMT+12", offset=-43200)
    alias ASIA_HONG_KONG = Self(name="Asia/Hong_Kong", offset=28800)
    alias ETC_GMT_MINUS_3 = Self(name="Etc/GMT-3", offset=10800)
    alias AMERICA_MIQUELON = Self(name="America/Miquelon", offset=-10800)
    alias EUROPE_VOLGOGRAD = Self(name="Europe/Volgograd", offset=10800)
    alias EUROPE_MADRID = Self(name="Europe/Madrid", offset=3600)
    alias AMERICA_MONTERREY = Self(name="America/Monterrey", offset=-21600)
    alias AMERICA_ANCHORAGE = Self(name="America/Anchorage", offset=-32400)
    alias AMERICA_ARGENTINA_SAN_LUIS = Self(name="America/Argentina/San_Luis", offset=-10800)
    alias AMERICA_EIRUNEPE = Self(name="America/Eirunepe", offset=-18000)
    alias AMERICA_ST_KITTS = Self(name="America/St_Kitts", offset=-14400)
    alias AMERICA_BAHIA_BANDERAS = Self(name="America/Bahia_Banderas", offset=-21600)
    alias ETC_GMT_PLUS_2 = Self(name="Etc/GMT+2", offset=-7200)
    alias ZULU = Self(name="Zulu", offset=0)
    alias AFRICA_GABORONE = Self(name="Africa/Gaborone", offset=7200)
    alias ANTARCTICA_MCMURDO = Self(name="Antarctica/McMurdo", offset=46800)
    alias EUROPE_GUERNSEY = Self(name="Europe/Guernsey", offset=0)
    alias EUROPE_ANDORRA = Self(name="Europe/Andorra", offset=3600)
    alias AMERICA_PARAMARIBO = Self(name="America/Paramaribo", offset=-10800)
    alias AMERICA_FORT_NELSON = Self(name="America/Fort_Nelson", offset=-25200)
    alias ANTARCTICA_TROLL = Self(name="Antarctica/Troll", offset=0)
    alias EUROPE_UZHGOROD = Self(name="Europe/Uzhgorod", offset=7200)
    alias ATLANTIC_CAPE_VERDE = Self(name="Atlantic/Cape_Verde", offset=-3600)
    alias UCT = Self(name="UCT", offset=0)
    alias ETC_GMT_MINUS_6 = Self(name="Etc/GMT-6", offset=21600)
    alias ASIA_SREDNEKOLYMSK = Self(name="Asia/Srednekolymsk", offset=39600)
    alias ASIA_UJUNG_PANDANG = Self(name="Asia/Ujung_Pandang", offset=28800)
    alias AMERICA_THUNDER_BAY = Self(name="America/Thunder_Bay", offset=-18000)
    alias AFRICA_KHARTOUM = Self(name="Africa/Khartoum", offset=7200)
    alias AFRICA_DOUALA = Self(name="Africa/Douala", offset=3600)
    alias AMERICA_CAYMAN = Self(name="America/Cayman", offset=-18000)
    alias BRAZIL_ACRE = Self(name="Brazil/Acre", offset=-18000)
    alias AMERICA_INDIANA_KNOX = Self(name="America/Indiana/Knox", offset=-21600)
    alias AUSTRALIA_YANCOWINNA = Self(name="Australia/Yancowinna", offset=34200)
    alias AMERICA_CHIHUAHUA = Self(name="America/Chihuahua", offset=-25200)
    alias AMERICA_RECIFE = Self(name="America/Recife", offset=-10800)
    alias AMERICA_INDIANA_MARENGO = Self(name="America/Indiana/Marengo", offset=-18000)
    alias ASIA_YANGON = Self(name="Asia/Yangon", offset=23400)
    alias EUROPE_ASTRAKHAN = Self(name="Europe/Astrakhan", offset=14400)
    alias ASIA_RANGOON = Self(name="Asia/Rangoon", offset=23400)
    alias AMERICA_VANCOUVER = Self(name="America/Vancouver", offset=-28800)
    alias NZ_CHAT = Self(name="NZ-CHAT", offset=49500)
    alias AMERICA_MONTERRAT = Self(name="America/Montserrat", offset=-14400)
    alias AMERICA_MERIDA = Self(name="America/Merida", offset=-21600)
    alias AMERICA_PUERTO_RICO = Self(name="America/Puerto_Rico", offset=-14400)
    alias AMERICA_MACEIO = Self(name="America/Maceio", offset=-10800)
    alias AMERICA_PANAMA = Self(name="America/Panama", offset=-18000)
    alias BRAZIL_EAST = Self(name="Brazil/East", offset=-10800)
    alias JAPAN = Self(name="Japan", offset=32400)
    alias AUSTRALIA_VICTORIA = Self(name="Australia/Victoria", offset=36000)
    alias AMERICA_INDIANA_PETERSBURG = Self(name="America/Indiana/Petersburg", offset=-18000)
    alias ASIA_DUSHANBE = Self(name="Asia/Dushanbe", offset=18000)
    alias AFRICA_ASMERA = Self(name="Africa/Asmera", offset=10800)
    alias ETC_ZULU = Self(name="Etc/Zulu", offset=0)
    alias EUROPE_MONACO = Self(name="Europe/Monaco", offset=3600)
    alias ASIA_AMMAN = Self(name="Asia/Amman", offset=7200)
    alias ASIA_KUWAIT = Self(name="Asia/Kuwait", offset=10800)
    alias ASIA_SAKHALIN = Self(name="Asia/Sakhalin", offset=39600)
    alias EUROPE_GIBRALTAR = Self(name="Europe/Gibraltar", offset=3600)
    alias AMERICA_HAVANA = Self(name="America/Havana", offset=-18000)
    alias ETC_GMT_PLUS_0 = Self(name="Etc/GMT+0", offset=0)
    alias ASIA_CHOIBALSAN = Self(name="Asia/Choibalsan", offset=32400)
    alias ASIA_VIENTIANE = Self(name="Asia/Vientiane", offset=25200)
    alias AFRICA_MONROVIA = Self(name="Africa/Monrovia", offset=0)
    alias AFRICA_LAGOS = Self(name="Africa/Lagos", offset=3600)
    alias AMERICA_ARGENTINA_BUENOS_AIRES = Self(name="America/Argentina/Buenos_Aires", offset=-10800)
    alias AUSTRALIA_MELBOURNE = Self(name="Australia/Melbourne", offset=36000)
    alias ETC_GMT_PLUS_6 = Self(name="Etc/GMT+6", offset=-21600)
    alias PST8PDT = Self(name="PST8PDT", offset=-28800)
    alias AMERICA_SCORESBYSUND = Self(name="America/Scoresbysund", offset=-3600)
    alias AUSTRALIA_ACT = Self(name="Australia/ACT", offset=36000)
    alias AFRICA_BLANTYRE = Self(name="Africa/Blantyre", offset=7200)
    alias ASIA_SAIGON = Self(name="Asia/Saigon", offset=25200)
    alias ASIA_CHONGQING = Self(name="Asia/Chongqing", offset=28800)
    alias GB_EIRE = Self(name="GB-Eire", offset=0)
    alias US_SAMOA = Self(name="US/Samoa", offset=-39600)
    alias ARCTIC_LONGYEARBYEN = Self(name="Arctic/Longyearbyen", offset=3600)
    alias AMERICA_CURACAO = Self(name="America/Curacao", offset=-14400)
    alias AMERICA_MEXICO_CITY = Self(name="America/Mexico_City", offset=-21600)
    alias ASIA_KABUL = Self(name="Asia/Kabul", offset=16200)
    alias AMERICA_INDIANAPOLIS = Self(name="America/Indianapolis", offset=-18000)
    alias ASIA_MACAO = Self(name="Asia/Macao", offset=28800)
    alias CANADA_CENTRAL = Self(name="Canada/Central", offset=-21600)
    alias ASIA_FAMAGUSTA = Self(name="Asia/Famagusta", offset=10800)
    alias AMERICA_ATIKOKAN = Self(name="America/Atikokan", offset=-18000)
    alias ASIA_BRUNEI = Self(name="Asia/Brunei", offset=28800)
    alias ASIA_UST_NERA = Self(name="Asia/Ust-Nera", offset=39600)
    alias BRAZIL_DE_NORONHA = Self(name="Brazil/DeNoronha", offset=-7200)
    alias INDIAN_CHAGOS = Self(name="Indian/Chagos", offset=21600)
    alias ASIA_KATHMANDU = Self(name="Asia/Kathmandu", offset=20700)
    alias ASIA_TEHRAN = Self(name="Asia/Tehran", offset=12600)
    alias AFRICA_DAR_ES_SALAAM = Self(name="Africa/Dar_es_Salaam", offset=10800)
    alias AMERICA_MANAGUA = Self(name="America/Managua", offset=-21600)
    alias AFRICA_CAIRO = Self(name="Africa/Cairo", offset=7200)
    alias PACIFIC_NAURU = Self(name="Pacific/Nauru", offset=43200)
    alias EUROPE_SARATOV = Self(name="Europe/Saratov", offset=14400)
    alias INDIAN_MALDIVES = Self(name="Indian/Maldives", offset=18000)
    alias ASIA_MAKASSAR = Self(name="Asia/Makassar", offset=28800)
    alias AMERICA_SAO_PAULO = Self(name="America/Sao_Paulo", offset=-10800)
    alias AMERICA_ST_JOHNS = Self(name="America/St_Johns", offset=-12600)
    alias ETC_GMT_PLUS_9 = Self(name="Etc/GMT+9", offset=-32400)
    alias ASIA_QYZYLORDA = Self(name="Asia/Qyzylorda", offset=18000)
    alias AUSTRALIA_NORTH = Self(name="Australia/North", offset=34200)
    alias AMERICA_MONTEVIDEO = Self(name="America/Montevideo", offset=-10800)
    alias AUSTRALIA_WEST = Self(name="Australia/West", offset=28800)
    alias EUROPE_OSLO = Self(name="Europe/Oslo", offset=3600)
    alias TURKEY = Self(name="Turkey", offset=10800)
    alias US_CENTRAL = Self(name="US/Central", offset=-21600)
    alias EUROPE_BERLIN = Self(name="Europe/Berlin", offset=3600)
    alias EUROPE_BRATISLAVA = Self(name="Europe/Bratislava", offset=3600)
    alias AMERICA_EL_SALVADOR = Self(name="America/El_Salvador", offset=-21600)
    alias AFRICA_KAMPALA = Self(name="Africa/Kampala", offset=10800)
    alias AMERICA_DAWSON = Self(name="America/Dawson", offset=-25200)
    alias AMERICA_LA_PAZ = Self(name="America/La_Paz", offset=-14400)
    alias US_ALEUTIAN = Self(name="US/Aleutian", offset=-36000)
    alias ASIA_KOLKATA = Self(name="Asia/Kolkata", offset=19800)
    alias ASIA_ORAL = Self(name="Asia/Oral", offset=18000)
    alias ASIA_OMSK = Self(name="Asia/Omsk", offset=21600)
    alias AMERICA_SANTIAGO = Self(name="America/Santiago", offset=-10800)
    alias AMERICA_DETROIT = Self(name="America/Detroit", offset=-18000)
    alias AMERICA_ANGUILLA = Self(name="America/Anguilla", offset=-14400)
    alias AMERICA_NOME = Self(name="America/Nome", offset=-32400)
    alias SINGAPORE = Self(name="Singapore", offset=28800)
    alias AFRICA_CONAKRY = Self(name="Africa/Conakry", offset=0)
    alias AFRICA_MAPUTO = Self(name="Africa/Maputo", offset=7200)
    alias ANTARCTICA_DAVIS = Self(name="Antarctica/Davis", offset=25200)
    alias ASIA_MANILA = Self(name="Asia/Manila", offset=28800)
    alias PACIFIC_MAJURO = Self(name="Pacific/Majuro", offset=43200)
    alias AFRICA_LUBUMBASHI = Self(name="Africa/Lubumbashi", offset=7200)
    alias PORTUGAL = Self(name="Portugal", offset=0)
    alias PACIFIC_PORT_MORESBY = Self(name="Pacific/Port_Moresby", offset=36000)
    alias ETC_GMT_PLUS_3 = Self(name="Etc/GMT+3", offset=-10800)
    alias CHILE_CONTINENTAL = Self(name="Chile/Continental", offset=-10800)
    alias GMT = Self(name="GMT", offset=0)
    alias AMERICA_MARTINIQUE = Self(name="America/Martinique", offset=-14400)
    alias AFRICA_SAO_TOME = Self(name="Africa/Sao_Tome", offset=0)
    alias AMERICA_SITKA = Self(name="America/Sitka", offset=-32400)
    alias ASIA_TAIPEI = Self(name="Asia/Taipei", offset=28800)
    alias INDIAN_MAYOTTE = Self(name="Indian/Mayotte", offset=10800)
    alias AMERICA_ARGENTINA_RIO_GALLEGOS = Self(name="America/Argentina/Rio_Gallegos", offset=-10800)
    alias AMERICA_MENOMINEE = Self(name="America/Menominee", offset=-21600)
    alias CANADA_PACIFIC = Self(name="Canada/Pacific", offset=-28800)
    alias MET = Self(name="MET", offset=3600)
    alias ASIA_THIMBU = Self(name="Asia/Thimbu", offset=21600)
    alias AMERICA_CAMPO_GRANDE = Self(name="America/Campo_Grande", offset=-14400)
    alias ASIA_MAGADAN = Self(name="Asia/Magadan", offset=39600)
    alias AFRICA_CASABLANCA = Self(name="Africa/Casablanca", offset=0)
    alias AMERICA_GUADELOUPE = Self(name="America/Guadeloupe", offset=-14400)
    alias ATLANTIC_FAROE = Self(name="Atlantic/Faroe", offset=0)
    alias ASIA_ANADYR = Self(name="Asia/Anadyr", offset=43200)
    alias AFRICA_PORTO_NOVO = Self(name="Africa/Porto-Novo", offset=3600)
    alias AFRICA_BANJUL = Self(name="Africa/Banjul", offset=0)
    alias INDIAN_COMORO = Self(name="Indian/Comoro", offset=10800)
    alias AMERICA_YAKUTAT = Self(name="America/Yakutat", offset=-32400)
    alias PACIFIC_GAMBIER = Self(name="Pacific/Gambier", offset=-32400)
    alias ASIA_ASHGABAT = Self(name="Asia/Ashgabat", offset=18000)
    alias ANTARCTICA_DUMONT_DURVILLE = Self(name="Antarctica/DumontDUrville", offset=36000)
    alias US_EAST_IND = Self(name="US/East-Indiana", offset=-18000)
    alias ASIA_IRKUTSK = Self(name="Asia/Irkutsk", offset=28800)
    alias AMERICA_MAZATLAN = Self(name="America/Mazatlan", offset=-25200)
    alias PACIFIC_APIA = Self(name="Pacific/Apia", offset=46800)
    alias AMERICA_BOA_VISTA = Self(name="America/Boa_Vista", offset=-14400)
    alias ETC_GMT = Self(name="Etc/GMT", offset=0)
    alias AMERICA_GUYANA = Self(name="America/Guyana", offset=-14400)
    alias AUSTRALIA_CURRIE = Self(name="Australia/Currie", offset=36000)
    alias EUROPE_ULYANOVSK = Self(name="Europe/Ulyanovsk", offset=14400)
    alias PACIFIC_FAKAOFO = Self(name="Pacific/Fakaofo", offset=46800)
    alias AMERICA_NORTH_DAKOTA_BEULAH = Self(name="America/North_Dakota/Beulah", offset=-21600)
    alias EUROPE_PRAGUE = Self(name="Europe/Prague", offset=3600)
    alias ASIA_QATAR = Self(name="Asia/Qatar", offset=10800)
    alias PACIFIC_FUNAFUTI = Self(name="Pacific/Funafuti", offset=43200)
    alias JAMAICA = Self(name="Jamaica", offset=-18000)
    alias CANADA_EASTERN = Self(name="Canada/Eastern", offset=-18000)
    alias PACIFIC_GUAM = Self(name="Pacific/Guam", offset=36000)
    alias PACIFIC_FIJI = Self(name="Pacific/Fiji", offset=43200)
    alias AFRICA_KIGALI = Self(name="Africa/Kigali", offset=7200)
    alias PACIFIC_TONGATAPU = Self(name="Pacific/Tongatapu", offset=46800)
    alias AMERICA_LIMA = Self(name="America/Lima", offset=-18000)
    alias ASIA_MUSCAT = Self(name="Asia/Muscat", offset=14400)
    alias ANTARCTICA_MACQUARIE = Self(name="Antarctica/Macquarie", offset=39600)
    alias ETC_GMT_MINUS_2 = Self(name="Etc/GMT-2", offset=7200)
    alias PACIFIC_PITCAIRN = Self(name="Pacific/Pitcairn", offset=-32400)
    alias CANADA_MOUNTAIN = Self(name="Canada/Mountain", offset=-25200)
    alias ASIA_YEKATERINBURG = Self(name="Asia/Yekaterinburg", offset=18000)
    alias PACIFIC_JOHNSTON = Self(name="Pacific/Johnston", offset=-36000)
    alias EUROPE_VATICAN = Self(name="Europe/Vatican", offset=3600)
    alias ATLANTIC_BERMUDA = Self(name="Atlantic/Bermuda", offset=-14400)
    alias ASIA_JERUSALEM = Self(name="Asia/Jerusalem", offset=7200)
    alias AMERICA_CIUDAD_JUAREZ = Self(name="America/Ciudad_Juarez", offset=-25200)
    alias PACIFIC_GALAPAGOS = Self(name="Pacific/Galapagos", offset=-21600)
    alias AMERICA_MONTREAL = Self(name="America/Montreal", offset=-18000)
    alias AFRICA_NOUAKCHOTT = Self(name="Africa/Nouakchott", offset=0)
    alias US_ARIZONA = Self(name="US/Arizona", offset=-25200)
    alias ASIA_KUCHING = Self(name="Asia/Kuching", offset=28800)
    alias ETC_GMT_PLUS_4 = Self(name="Etc/GMT+4", offset=-14400)
    alias AUSTRALIA_BRISBANE = Self(name="Australia/Brisbane", offset=36000)
    alias CANADA_SASKATCHEWAN = Self(name="Canada/Saskatchewan", offset=-21600)
    alias EUROPE_DUBLIN = Self(name="Europe/Dublin", offset=0)
    alias ASIA_QOSTANAY = Self(name="Asia/Qostanay", offset=21600)
    alias AMERICA_EDMONTON = Self(name="America/Edmonton", offset=-25200)
    alias ATLANTIC_REYKJAVIK = Self(name="Atlantic/Reykjavik", offset=0)
    alias AMERICA_FORTALEZA = Self(name="America/Fortaleza", offset=-10800)
    alias PACIFIC_KIRITIMATI = Self(name="Pacific/Kiritimati", offset=50400)
    ...
    alias PACIFIC_YAP = Self(name="Pacific/Yap", offset=36000)
    alias AMERICA_SANTO_DOMINGO = Self(name="America/Santo_Domingo", offset=-14400)
    alias ICELAND = Self(name="Iceland", offset=0)
    alias AMERICA_ARAGUAINA = Self(name="America/Araguaina", offset=-10800)
    alias ASIA_KARACHI = Self(name="Asia/Karachi", offset=18000)
    alias ETC_GMT_PLUS_7 = Self(name="Etc/GMT+7", offset=-25200)
    alias AFRICA_BUJUMBURA = Self(name="Africa/Bujumbura", offset=7200)
    alias AMERICA_DAWSON_CREEK = Self(name="America/Dawson_Creek", offset=-25200)
    alias EUROPE_ZAPOROZHYE = Self(name="Europe/Zaporozhye", offset=7200)
    alias ASIA_ULAANBAATAR = Self(name="Asia/Ulaanbaatar", offset=28800)
    alias PACIFIC_SAMOA = Self(name="Pacific/Samoa", offset=-39600)
    alias AUSTRALIA_DARWIN = Self(name="Australia/Darwin", offset=34200)
    alias ETC_GMT0 = Self(name="Etc/GMT0", offset=0)
    alias PACIFIC_TAHITI = Self(name="Pacific/Tahiti", offset=-36000)
    alias ETC_GMT_MINUS_8 = Self(name="Etc/GMT-8", offset=28800)
    alias ATLANTIC_FAEROE = Self(name="Atlantic/Faeroe", offset=0)
    alias AFRICA_LIBREVILLE = Self(name="Africa/Libreville", offset=3600)
    alias ASIA_BARNAUL = Self(name="Asia/Barnaul", offset=25200)
    alias AMERICA_CORAL_HARBOUR = Self(name="America/Coral_Harbour", offset=-18000)
    alias ANTARCTICA_SYOWA = Self(name="Antarctica/Syowa", offset=10800)
    alias AMERICA_BUENOS_AIRES = Self(name="America/Buenos_Aires", offset=-10800)
    alias EUROPE_VIENNA = Self(name="Europe/Vienna", offset=3600)
    alias AMERICA_FORT_WAYNE = Self(name="America/Fort_Wayne", offset=-18000)
    alias NZ = Self(name="NZ", offset=43200)
    alias ATLANTIC_AZORES = Self(name="Atlantic/Azores", offset=-3600)
    alias AMERICA_COYHAIQUE = Self(name="America/Coyhaique", offset=-10800)
    alias ASIA_PYONGYANG = Self(name="Asia/Pyongyang", offset=32400)
    alias ETC_GMT_MINUS_10 = Self(name="Etc/GMT-10", offset=36000)
    alias MST = Self(name="MST", offset=-25200)
    alias AMERICA_ARGENTINA_JUJUY = Self(name="America/Argentina/Jujuy", offset=-10800)
    alias AMERICA_TIJUANA = Self(name="America/Tijuana", offset=-28800)
    alias PACIFIC_GUADALCANAL = Self(name="Pacific/Guadalcanal", offset=39600)
    alias EUROPE_STOCKHOLM = Self(name="Europe/Stockholm", offset=3600)
    alias US_ALASKA = Self(name="US/Alaska", offset=-32400)
    alias EUROPE_TIRASPOL = Self(name="Europe/Tiraspol", offset=7200)
    alias EUROPE_SAMARA = Self(name="Europe/Samara", offset=14400)
    alias ETC_GMT_MINUS_12 = Self(name="Etc/GMT-12", offset=43200)
    alias KWAJALEIN = Self(name="Kwajalein", offset=43200)
    alias ASIA_MACAU = Self(name="Asia/Macau", offset=28800)
    alias PACIFIC_TRUK = Self(name="Pacific/Truk", offset=36000)
    alias ASIA_BANGKOK = Self(name="Asia/Bangkok", offset=25200)
    alias AMERICA_ANTIGUA = Self(name="America/Antigua", offset=-14400)
    alias AFRICA_EL_AAIUN = Self(name="Africa/El_Aaiun", offset=0)
    alias EUROPE_MARIEHAMN = Self(name="Europe/Mariehamn", offset=7200)
    alias ASIA_JAYAPURA = Self(name="Asia/Jayapura", offset=32400)
    alias EUROPE_SAN_MARINO = Self(name="Europe/San_Marino", offset=3600)
    alias US_PACIFIC = Self(name="US/Pacific", offset=-28800)
    alias AFRICA_JOHANNESBURG = Self(name="Africa/Johannesburg", offset=7200)
    alias AUSTRALIA_EUCLA = Self(name="Australia/Eucla", offset=31500)
    alias AFRICA_NAIROBI = Self(name="Africa/Nairobi", offset=10800)
    alias ETC_GMT_MINUS_7 = Self(name="Etc/GMT-7", offset=25200)
    alias AMERICA_INUVIK = Self(name="America/Inuvik", offset=-25200)
    alias ASIA_TOKYO = Self(name="Asia/Tokyo", offset=32400)
    alias ASIA_ATYRAU = Self(name="Asia/Atyrau", offset=18000)
    alias ASIA_KASHGAR = Self(name="Asia/Kashgar", offset=21600)
    alias W_SU = Self(name="W-SU", offset=10800)
    alias ASIA_TASHKENT = Self(name="Asia/Tashkent", offset=18000)
    alias AFRICA_FREETOWN = Self(name="Africa/Freetown", offset=0)
    alias PACIFIC_PAGO_PAGO = Self(name="Pacific/Pago_Pago", offset=-39600)
    alias AMERICA_DENVER = Self(name="America/Denver", offset=-25200)
    alias AUSTRALIA_LHI = Self(name="Australia/LHI", offset=37800)
    alias PACIFIC_RAROTONGA = Self(name="Pacific/Rarotonga", offset=-36000)
    alias MST7MDT = Self(name="MST7MDT", offset=-25200)
    alias PACIFIC_NOUMEA = Self(name="Pacific/Noumea", offset=39600)
    alias ETC_UCT = Self(name="Etc/UCT", offset=0)
    alias ETC_GMT_PLUS_10 = Self(name="Etc/GMT+10", offset=-36000)
    alias ROK = Self(name="ROK", offset=32400)
    alias PACIFIC_AUCKLAND = Self(name="Pacific/Auckland", offset=43200)
    alias ASIA_NOVOKUZNETSK = Self(name="Asia/Novokuznetsk", offset=25200)
    alias AMERICA_HERMOSILLO = Self(name="America/Hermosillo", offset=-25200)
    alias AMERICA_LOUISVILLE = Self(name="America/Louisville", offset=-18000)
    alias ASIA_HO_CHI_MINH = Self(name="Asia/Ho_Chi_Minh", offset=25200)
    alias ASIA_YEREVAN = Self(name="Asia/Yerevan", offset=14400)
    alias ASIA_YAKUTSK = Self(name="Asia/Yakutsk", offset=32400)
    alias UNIVERSAL = Self(name="Universal", offset=0)
    alias AMERICA_TEGUCIGALPA = Self(name="America/Tegucigalpa", offset=-21600)
    alias MEXICO_BAJANORTE = Self(name="Mexico/BajaNorte", offset=-28800)
    alias EUROPE_SARAJEVO = Self(name="Europe/Sarajevo", offset=3600)
    alias AMERICA_ARGENTINA_CATAMARCA = Self(name="America/Argentina/Catamarca", offset=-10800)
    alias CUBA = Self(name="Cuba", offset=-18000)
    alias ASIA_KHANDYGA = Self(name="Asia/Khandyga", offset=32400)
    alias AMERICA_LOWER_PRINCES = Self(name="America/Lower_Princes", offset=-14400)
    alias AMERICA_BLANC_SABLON = Self(name="America/Blanc-Sablon", offset=-14400)
    alias AMERICA_BOGOTA = Self(name="America/Bogota", offset=-18000)
    alias AFRICA_LOME = Self(name="Africa/Lome", offset=0)
    alias AMERICA_TORONTO = Self(name="America/Toronto", offset=-18000)
    alias EUROPE_WARSAW = Self(name="Europe/Warsaw", offset=3600)
    alias AMERICA_YELLOWKNIFE = Self(name="America/Yellowknife", offset=-25200)
    alias AMERICA_SWIFT_CURRENT = Self(name="America/Swift_Current", offset=-21600)
    alias EST = Self(name="EST", offset=-18000)
    alias EUROPE_SOFIA = Self(name="Europe/Sofia", offset=7200)
    alias AFRICA_CEUTA = Self(name="Africa/Ceuta", offset=3600)
    alias AMERICA_MARIGOT = Self(name="America/Marigot", offset=-14400)
    alias AMERICA_DANMARKSHAVN = Self(name="America/Danmarkshavn", offset=0)
    alias AFRICA_HARARE = Self(name="Africa/Harare", offset=7200)
    ...
    alias EST5EDT = Self(name="EST5EDT", offset=-18000)
    alias PACIFIC_MIDWAY = Self(name="Pacific/Midway", offset=-39600)
    alias ASIA_ISTANBUL = Self(name="Asia/Istanbul", offset=10800)
    alias AMERICA_ARGENTINA_COMODRIVADAVIA = Self(name="America/Argentina/ComodRivadavia", offset=-10800)
    alias ASIA_BAKU = Self(name="Asia/Baku", offset=14400)
    alias AUSTRALIA_NSW = Self(name="Australia/NSW", offset=36000)
    alias EUROPE_BUSINGEN = Self(name="Europe/Busingen", offset=3600)
    alias AMERICA_REGINA = Self(name="America/Regina", offset=-21600)
    alias AFRICA_BANGUI = Self(name="Africa/Bangui", offset=3600)
    alias POLAND = Self(name="Poland", offset=3600)
    alias INDIAN_CHRISTMAS = Self(name="Indian/Christmas", offset=25200)
    alias AUSTRALIA_QUEENSLAND = Self(name="Australia/Queensland", offset=36000)
    alias ASIA_BISHKEK = Self(name="Asia/Bishkek", offset=21600)
    alias ASIA_DUBAI = Self(name="Asia/Dubai", offset=14400)
    alias AFRICA_MBABANE = Self(name="Africa/Mbabane", offset=7200)
    alias AMERICA_GRAND_TURK = Self(name="America/Grand_Turk", offset=-18000)
    alias AMERICA_GLACE_BAY = Self(name="America/Glace_Bay", offset=-14400)
    alias PACIFIC_ENDERBURY = Self(name="Pacific/Enderbury", offset=46800)
    alias AFRICA_DAKAR = Self(name="Africa/Dakar", offset=0)
    alias AFRICA_ALGIERS = Self(name="Africa/Algiers", offset=3600)
    alias ASIA_DAMASCUS = Self(name="Asia/Damascus", offset=7200)
    alias AMERICA_RANKIN_INLET = Self(name="America/Rankin_Inlet", offset=-21600)
    alias EUROPE_BRUSSELS = Self(name="Europe/Brussels", offset=3600)
    alias ASIA_HOVD = Self(name="Asia/Hovd", offset=25200)
    alias AUSTRALIA_HOBART = Self(name="Australia/Hobart", offset=39600)
    alias EUROPE_BUCHAREST = Self(name="Europe/Bucharest", offset=7200)
    alias ASIA_GAZA = Self(name="Asia/Gaza", offset=7200)
    alias IRAN = Self(name="Iran", offset=12600)
    alias AFRICA_DJIBOUTI = Self(name="Africa/Djibouti", offset=10800)
    alias AMERICA_ROSARIO = Self(name="America/Rosario", offset=-10800)
    alias EUROPE_BELGRADE = Self(name="Europe/Belgrade", offset=3600)
    alias ANTARCTICA_ROTHERA = Self(name="Antarctica/Rothera", offset=-10800)
    alias AFRICA_ADDIS_ABABA = Self(name="Africa/Addis_Ababa", offset=10800)
    alias ASIA_DACCA = Self(name="Asia/Dacca", offset=21600)
    ...
    alias US_MOUNTAIN = Self(name="US/Mountain", offset=-25200)
    alias EGYPT = Self(name="Egypt", offset=7200)
    alias AMERICA_ARGENTINA_TUCUMAN = Self(name="America/Argentina/Tucuman", offset=-10800)
    alias ATLANTIC_ST_HELENA = Self(name="Atlantic/St_Helena", offset=0)
    alias GREENWICH = Self(name="Greenwich", offset=0)
    alias ASIA_ASHKHABAD = Self(name="Asia/Ashkhabad", offset=18000)
    alias EUROPE_NICOSIA = Self(name="Europe/Nicosia", offset=7200)
    alias ASIA_AQTAU = Self(name="Asia/Aqtau", offset=18000)
    alias ANTARCTICA_MAWSON = Self(name="Antarctica/Mawson", offset=18000)
    alias AMERICA_NORTH_DAKOTA_CENTER = Self(name="America/North_Dakota/Center", offset=-21600)
    alias EET = Self(name="EET", offset=7200)
    alias ROC = Self(name="ROC", offset=28800)
    alias AMERICA_MENDOZA = Self(name="America/Mendoza", offset=-10800)
    alias AMERICA_ST_VINCENT = Self(name="America/St_Vincent", offset=-14400)
    alias CST6CDT = Self(name="CST6CDT", offset=-21600)
    alias ASIA_BAHRAIN = Self(name="Asia/Bahrain", offset=10800)
    ...
    alias EUROPE_COPENHAGEN = Self(name="Europe/Copenhagen", offset=3600)
    alias AMERICA_ARGENTINA_SALTA = Self(name="America/Argentina/Salta", offset=-10800)
    alias AFRICA_MALABO = Self(name="Africa/Malabo", offset=3600)
    alias AMERICA_MATAMOROS = Self(name="America/Matamoros", offset=-21600)
    alias AMERICA_ARGENTINA_LA_RIOJA = Self(name="America/Argentina/La_Rioja", offset=-10800)
    alias AFRICA_ACCRA = Self(name="Africa/Accra", offset=0)
    alias EIRE = Self(name="Eire", offset=0)
    alias AMERICA_KENTUCKY_LOUISVILLE = Self(name="America/Kentucky/Louisville", offset=-18000)
    alias AFRICA_BAMAKO = Self(name="Africa/Bamako", offset=0)
    alias ETC_GMT_5 = Self(name="Etc/GMT-5", offset=18000)
    alias PACIFIC_CHATHAM = Self(name="Pacific/Chatham", offset=45900)
    alias WET = Self(name="WET", offset=0)
    alias ETC_GMT_PLUS_5 = Self(name="Etc/GMT+5", offset=-18000)
    alias AFRICA_MOGADISHU = Self(name="Africa/Mogadishu", offset=10800)
    alias AMERICA_THULE = Self(name="America/Thule", offset=-10800)
    alias AMERICA_PHOENIX = Self(name="America/Phoenix", offset=-25200)
    alias AUSTRALIA_LORD_HOWE = Self(name="Australia/Lord_Howe", offset=37800)
    alias PACIFIC_CHUUK = Self(name="Pacific/Chuuk", offset=36000)
    alias PACIFIC_MARQUESAS = Self(name="Pacific/Marquesas", offset=-34200)
    alias PACIFIC_WAKE = Self(name="Pacific/Wake", offset=43200)
    alias AFRICA_BRAZZAVILLE = Self(name="Africa/Brazzaville", offset=3600)
    alias AUSTRALIA_BROKEN_HILL = Self(name="Australia/Broken_Hill", offset=34200)
    alias AUSTRALIA_SOUTH = Self(name="Australia/South", offset=34200)
    alias AMERICA_KENTUCKY_MONTICELLO = Self(name="America/Kentucky/Monticello", offset=-18000)
    alias EUROPE_KIEV = Self(name="Europe/Kiev", offset=7200)
    alias ETC_GMT_9 = Self(name="Etc/GMT-9", offset=32400)
    alias AUSTRALIA_LINDEMAN = Self(name="Australia/Lindeman", offset=36000)
    alias AMERICA_METLAKATLA = Self(name="America/Metlakatla", offset=-28800)
    alias AMERICA_GOOSE_BAY = Self(name="America/Goose_Bay", offset=-14400)
    alias AMERICA_ST_LUCIA = Self(name="America/St_Lucia", offset=-14400)
    alias EUROPE_LJUBLJANA = Self(name="Europe/Ljubljana", offset=3600)
    alias EUROPE_TIRANE = Self(name="Europe/Tirane", offset=3600)
    alias AMERICA_SANTAREM = Self(name="America/Santarem", offset=-10800)
    alias ATLANTIC_CANARY = Self(name="Atlantic/Canary", offset=0)
    alias AMERICA_GRENADA = Self(name="America/Grenada", offset=-14400)
    alias AMERICA_SHIPROCK = Self(name="America/Shiprock", offset=-25200)
    alias EUROPE_SKOPJE = Self(name="Europe/Skopje", offset=3600)
    alias ETC_GMT_PLUS_8 = Self(name="Etc/GMT+8", offset=-28800)
    alias ASIA_BAGHDAD = Self(name="Asia/Baghdad", offset=10800)
    alias AUSTRALIA_SYDNEY = Self(name="Australia/Sydney", offset=36000)
    alias EUROPE_ISTANBUL = Self(name="Europe/Istanbul", offset=10800)
    alias AMERICA_DOMINICA = Self(name="America/Dominica", offset=-14400)
    alias AMERICA_NIPIGON = Self(name="America/Nipigon", offset=-18000)
    alias ASIA_CALCUTTA = Self(name="Asia/Calcutta", offset=19800)
    alias ETC_GMT_0 = Self(name="Etc/GMT-0", offset=0)
    alias ANTARCTICA_CASEY = Self(name="Antarctica/Casey", offset=28800)
    alias ASIA_VLADIVOSTOK = Self(name="Asia/Vladivostok", offset=36000)
    alias AMERICA_GODTHAB = Self(name="America/Godthab", offset=-10800)
    alias ASIA_AQTUBE = Self(name="Asia/Aqtube", offset=18000)
    alias EUROPE_KIROV = Self(name="Europe/Kirov", offset=10800)
    alias ASIA_ADEN = Self(name="Asia/Aden", offset=10800)
